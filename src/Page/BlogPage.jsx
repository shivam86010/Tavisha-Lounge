  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Discover how our chefs combine traditional techniques with modern innovation to create unforgettable culinary experiences.",
      content:
        "At Tavisha Lounge, we believe fine dining is more than just exceptional food—it's a symphony of flavors, presentation, and atmosphere. Our executive chef shares insights into the meticulous process behind each dish.",
    ...
    },
    {
      ...
      excerpt:
        "Explore our sommelier's guide to selecting wines that complement the rich flavors of our signature dishes.",
      content:
        "Pairing wine with Indian cuisine requires understanding the balance of spices and flavors. Our sommelier has curated a selection that enhances every note of our royal dishes.",
      author: "Sommelier Priya Sharma",
      date: "2024-03-10",
      readTime: "4 min read",
      category: "Wine & Beverages",
      image:
        "https://images.unsplash.com/photo-1474722883778-792e7990302f?ixlib=rb-4.0.3&auto=format&fit=crop&w=2069&q=80",
      featured: false,
      likes: 89,
      shares: 32,
    },
    {
      ...
      excerpt:
        "A journey through the creation of our signature Royal Thali, featuring seven courses of culinary excellence.",
      content:
        "Each element of our Royal Thali tells a story of regional cuisine and royal heritage. From sourcing ingredients to final presentation, every detail matters.",
    ...
    },
    {
      ...
      excerpt:
        "How Tavisha Lounge partners with local farmers and producers to ensure the freshest ingredients while supporting communities.",
      content:
        "Sustainability isn't just a trend—it's our responsibility. We work directly with organic farms and ethical suppliers to bring you the finest ingredients.",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-600 mb-10 leading-relaxed max-w-xl">
                Where every dish tells a story, and every meal becomes a
                cherished memory. Experience culinary artistry at its finest.
              </p>
              ...
              {currentPosts
                ...
                .map((post, index) => (
                  ...
                  >
                    ...
                    >
                      <Bookmark
                        className={`h-5 w-5 ${savedPosts.includes(post.id) ? "fill-royal-maroon text-royal-maroon" : "text-gray-400"}`}
                      />
                    </button>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                        <div className="flex items-center gap-4">
                          ...
                          >
                            <Heart
                              className={`h-5 w-5 ${likedPosts.includes(post.id) ? "fill-red-500" : ""}`}
                            />
                        ...
                        <Link
                          to={`/blog/${post.id}`}
                          className="group text-royal-maroon hover:text-royal-maroon-dark font-semibold text-sm flex items-center gap-2"
                        >
                          <span>Read More</span>
                          <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
                        </Link>
            ...
            <div className="sticky top-8 space-y-8">
              ...
              <div className="bg-gradient-to-br from-royal-maroon to-royal-maroon-dark rounded-2xl p-6 text-white shadow-soft-lg">
                ...
                <p className="text-white/80 mb-6 text-sm">
                  Subscribe to receive exclusive recipes, stories, and special
                  offers
                </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed max-w-xl">
                At Tavisha Lounge, every meal is a masterpiece. Our chefs craft
                unforgettable experiences using the finest ingredients,
                    ...
                    <div className="p-4 bg-gradient-to-br from-soft-cream to-white rounded-xl border border-gray-100">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <div className="font-bold text-royal-maroon">
                      ...
                      <p className="text-xs text-gray-400 mt-2">
                        For reservations made 48+ hours in advance
                      </p>
                    </div>
                  </div>
